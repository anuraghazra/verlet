...
const uiu = (function () {
    ...
    function onkey(keyStr,callback) {
        let keys = {
            ///WINDOWS///
            '16': 'SHIFT',
            '17': 'CTRL',
        ...
        setOn('keydown',document.body,function(e) {
        ...
        setOn('keyup',document.body,function() {
            if(!isSingle) {
                mulKeys.pop();
            }
        });
    ...
    function tooltip(option) {
        ...
        let tooltip = document.createElement('div');
            ...
            tooltip.setAttribute('id','uiuTooltip');
        ...
        setOn('mousemove',parent,function(e) {
            setStyle(tooltip,{
    ...
    function modal(option) {
        ...
        setOn(option.on || 'click',parent,toggleModal);
