...
const drag = function(verlet,dots,cons) {
    ...
    this.getUpCoord = function(e) {
        if(self.bool) {
            ...
            let adjustX = self.downX-self.dragX;
            let adjustY = self.downY-self.dragY-40;
    ...
    this.drawTmpBox = function (bool) {
        ...
        if(self.draw && self.bool) {
            ...
            self.verlet.ctx.strokeStyle = 'white';
            self.verlet.ctx.strokeRect(self.downX,self.downY-40,diffX,diffY);
        }
    }
}